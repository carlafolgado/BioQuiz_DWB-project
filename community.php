...
<body class="bg-light"> 
  <main class="container">
    <div class="row p-4">
      ...
      <?php 
        ...
        while ($value = mysqli_fetch_assoc($res)) {
          if ($value['Picture'] != NULL) {
            echo '<img class="mx-auto d-block mb-3" style = "object-fit:cover; border-radius: 50%; width: 120px; height: 120px;" src = "'.$value['Picture'].'">';
          } else {
            echo '<img class="mx-auto d-block mb-3" style = "object-fit:cover; border-radius: 50%; width: 120px; height: 120px;" src = "user.png">';
          }
        }
      ?>
        <h8 class="font-italic" style="font-weight: bold;">
          <?php echo $id; ?>
        ...
        <p class="mb-0 text-break">Quizzes created:  <a style="font-weight: 550; font-size: 16px;"><?php echo $number_created ?></a> <br>
      ...
      <div class="col-9">
        <h2 class="p-2 mb-1 rounded text-center">Latest questionnaires</h1>
        <hr class="feature-divider mt-0" style="border-color: #6da4d1">
        <?php
          $query = "SELECT * FROM Questionnaire ORDER BY idQuestionnaire DESC LIMIT 5;";
          $res = mysqli_query($mysqli, $query);
          while ($row = mysqli_fetch_assoc($res)) {
